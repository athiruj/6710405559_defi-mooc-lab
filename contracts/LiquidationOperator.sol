...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    function operate() external {
        ...
        uniswapV2Pair_WBTC_USDT.swap(0, debt_USDT, address(this), "flash");
        ...
        (uint256 res_WBTC_P2, uint256 res_WETH_P2, ) = uniswapV2Pair_WBTC_WETH.getReserves();
        uint amountOut_WETH = getAmountOut(profit_WBTC, res_WBTC_P2, res_WETH_P2);
    ...
    function uniswapV2Call(
        ...
        (uint256 reserve_WBTC, uint256 reserve_USDT, ) = uniswapV2Pair_WBTC_USDT.getReserves();

        // 2.1 liquidate the target user
        
        USDT.approve(address(lendingPool), amount1);
        lendingPool.liquidationCall(address(WBTC), address(USDT), liquidationTarget, amount1, false);
        ...
        uint repay_WBTC = getAmountIn(amount1, reserve_WBTC, reserve_USDT);
